...
COMPILER_SPECIFIC_STANDARD_CFLAGS   = -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -std=gnu11                 $(if $(filter yes,$(BROADCOM_INTERNAL) $(TESTER)),-Werror)
COMPILER_SPECIFIC_STANDARD_CXXFLAGS = -Wall -fsigned-char -ffunction-sections -fdata-sections -fno-common -fno-rtti -fno-exceptions  $(if $(filter yes,$(BROADCOM_INTERNAL) $(TESTER)),-Werror)
