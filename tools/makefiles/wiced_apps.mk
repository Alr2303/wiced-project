...
FILESYSTEM_IMAGE_PACKAGE: $(FILESYSTEM_IMAGE_PACKAGE_DEPENDENCY)
	$(call ADD_TO_PACKAGE, $(FILESYSTEM_IMAGE), $(FILESYSTEM_IMAGE_SECTOR_ADDRESS))
endif
...
APP0_PACKAGE: $(APP0_PACKAGE_DEPENDENCY)
	$(call ADD_TO_PACKAGE, $(APP0), $(APP0_SECTOR_ADDRESS))
endif
...
APPS_LUT_PACKAGE: $(FINAL_APPS_FILE) $(APPS_PACKAGE_DEPENDENCY) APPS_LOOKUP_TABLE_RULES
	$(QUIET)$(ECHO) Packaging apps lookup table in wiced_apps.mk ... $(FINAL_APPS_FILE) @ $(APPS_LUT_HEADER_LOC) size $(APP_LUT_SECTOR_COUNT)
	$(call ADD_TO_PACKAGE, $(FINAL_APPS_FILE), $(APPS_LUT_HEADER_LOC))
...
OTA2_IMAGE_DEPENDENCIES	:= $(DCT_IMAGE) $(FILESYSTEM_IMAGE) $(FINAL_APPS_FILE) $(OTA_APP) $(WIFI_FIRMWARE) $(APP0) $(APP1) $(APP2) $(SECURE_APP0) $(SECURE_FS_IMAGE) $(DCT_IMAGE_PLATFORM)
