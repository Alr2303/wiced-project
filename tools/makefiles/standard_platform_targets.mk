...
package_bootloader: bootloader display_map_summary package_dct
	...
	$(call ADD_TO_PACKAGE, $(BOOTLOADER_OUTFILE).stripped$(LINK_OUTPUT_SUFFIX), "")
...
package_dct: $(DCT_IMAGE_PLATFORM) display_map_summary
	...
	$(call ADD_TO_PACKAGE, $(STRIPPED_LINK_DCT_FILE), "")
else
download_dct:
	@:
...
$(RELEASE_PACKAGE): create_package_descriptor \
		...
		package_bootloader $(if $(findstring no_dct,$(MAKECMDGOALS)),,package_dct) package_app

package_app: $(STRIPPED_LINK_OUTPUT_FILE)
	$(QUIET)$(ECHO) Packaging Application ...
	$(call ADD_TO_PACKAGE, $(STRIPPED_LINK_OUTPUT_FILE), "")
