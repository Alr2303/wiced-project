...
const platform_adc_t platform_adc_peripherals[] =
{
	...
	[WICED_ADC_1] = {ADC1, ADC_Channel_13, RCC_APB2Periph_ADC1, 1, &platform_gpio_pins[WICED_GPIO_36]},
...
{
	[WICED_PWM_1]  = {TIM3, 1, RCC_APB1Periph_TIM3, GPIO_AF_TIM3, &platform_gpio_pins[WICED_GPIO_21]}, /* PB4, TIM3_CH1 */
};
#endif
...
#if defined(TARGET_LED_GW) || defined(TARGET_USB_GW) || defined(TARGET_TS_GW)
	[WICED_UART_2] =
	{
		.port               = USART6,
...
void platform_led_init( void )
{
	...
	platform_gpio_init( &platform_gpio_pins[LEDGW_SERVER_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_SERVER_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P2_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P2_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P3_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P3_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P4_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P4_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_WIFI_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_WIFI_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P1_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[LEDGW_P1_R], OUTPUT_PUSH_PULL );
	
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_SERVER_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_SERVER_R] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P2_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P2_R] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P3_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P3_R] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P4_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P4_R] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_WIFI_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_WIFI_R] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P1_G] );
	platform_gpio_output_low( &platform_gpio_pins[LEDGW_P1_R] );
#elif defined(TARGET_USB_GW)
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_SENSOR_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_SENSOR_Y], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_BAT_Y], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_CPU_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_CPU_Y], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_WIFI_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_WIFI_Y], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_LED_FAULT_R], OUTPUT_PUSH_PULL );
	
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_SENSOR_G] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_SENSOR_Y] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_BAT_Y] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_CPU_G] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_CPU_Y] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_WIFI_G] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_WIFI_Y] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_LED_FAULT_R] );
#elif defined(TARGET_TS_GW)
	platform_gpio_init( &platform_gpio_pins[TSGW_SERVER_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_SERVER_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_WIFI_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_WIFI_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_USB_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_USB_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_LED_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_LED_R], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_BELL_G], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_BELL_R], OUTPUT_PUSH_PULL );

	platform_gpio_output_low( &platform_gpio_pins[TSGW_SERVER_G] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_SERVER_R] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_WIFI_G] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_WIFI_R] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_USB_G] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_USB_R] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_LED_G] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_LED_R] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_BELL_G] );
	platform_gpio_output_low( &platform_gpio_pins[TSGW_BELL_R] );
#endif
}
...
void platform_init_external_devices( void )
{
	...
	/* gpi, button */
	platform_gpio_init( &platform_gpio_pins[GPIO_BUTTON_1], INPUT_PULL_UP );
	platform_gpio_init( &platform_gpio_pins[GPIO_BUTTON_2], INPUT_PULL_UP );
	platform_gpio_init( &platform_gpio_pins[GPIO_BUTTON_3], INPUT_PULL_UP );
	platform_gpio_init( &platform_gpio_pins[GPIO_BUTTON_4], INPUT_PULL_UP );
#elif defined(TARGET_USB_GW)
	/* adc */
	...
	/* gpo */
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_CHG_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_P1_POWER_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_P2_POWER_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_USB1_BIT_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_USB2_BIT_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_USB3_BIT_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_USB4_BIT_ON], OUTPUT_PUSH_PULL );
	
	platform_gpio_output_high( &platform_gpio_pins[USBGW_GPO_CHG_ON] );
	platform_gpio_output_high( &platform_gpio_pins[USBGW_GPO_P1_POWER_ON] );
	platform_gpio_output_high( &platform_gpio_pins[USBGW_GPO_P2_POWER_ON] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_GPO_USB1_BIT_ON] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_GPO_USB2_BIT_ON] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_GPO_USB3_BIT_ON] );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_GPO_USB4_BIT_ON] );

	platform_gpio_init( &platform_gpio_pins[USBGW_GPO_UART_SEL], OUTPUT_PUSH_PULL );
	platform_gpio_output_low( &platform_gpio_pins[USBGW_GPO_UART_SEL] );
	...
	/* gpo */
	platform_gpio_init( &platform_gpio_pins[TSGW_USB_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_LED_ON], OUTPUT_PUSH_PULL );
	platform_gpio_init( &platform_gpio_pins[TSGW_BELL_ON], OUTPUT_PUSH_PULL );
