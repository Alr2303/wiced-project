...
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_4  | 134 | GPIO_8       | GPIO_8_TAP_SEL          | C16 | GPIO_8_TAP_SEL           | J12:5 |  GPIO        | ARD_MISO                      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_5  | 94  | GPIO_9       | GPIO_9_USB_SEL          | C15 | GPIO_9                   | J12:6 |  GPIO        | ARD_SCK                       |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_6  | 146 | GPIO_10      | GPIO_10                 | A45 | GPIO_10                  | J12:4 |  GPIO        | ARD_MOSI                      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_7  | 140 | GPIO_11      | GPIO_11_ACPU_BOOT_MODE  | C4  | GPIO_11_ACPU_BOOT_MODE   | J12:3 |  GPIO        | ARD_SS                        |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_8  | 143 | GPIO_12      | GPIO_12                 | C14 | GPIO_12                  | J12:2 |  GPIO        | ARD_GPIO9                     |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
...
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_16 | 189 | PWM_3        | PWM_3                   | A26 | PWM_3                    | xxxx  |  PWM, GPIO   | TP4                           |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_17 | 187 | PWM_4        | PWM_4                   | A31 | PWM_4                    | J6:1  |  PWM, GPIO   |                               |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_18 | 188 | PWM_5        | PWM_5                   | D7  | PWM_5                    | J6:2  |  PWM, GPIO   |                               |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
...
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_50 | 90  | I2C1_SDATA   | I2C_1_SDA               | C1  | I2C_1_SDA                | J13:5 |  GPIO        | ARD_AD4_SDA                   |
|---------------+-----+--------------+-------------------------+-----+--------------------------+-------+--------------+-------------------------------|
| WICED_GPIO_51 | 89  | I2C1_CLK     | I2C_1_SCL               | B2  | I2C_1_SCL                | J13:6 |  GPIO        | ARD_AD4_SCL                   |
+------------------------------------------------------------------------------------------------------------------------------------------------------+
...
/* Note: The BCM943907AEVAL1F hardware does not have physical LEDs or Buttons so the #defines are mapped to PWM 4,5 and SPI on the expansion header J6 */
#define WICED_LED1       ( WICED_GPIO_17 )
#define WICED_LED2       ( WICED_GPIO_19 )
#define WICED_BUTTON1    ( WICED_GPIO_18 )
#define WICED_BUTTON2    ( WICED_GPIO_20 )
