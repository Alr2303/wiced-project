...
/* Determine if the notify callback option should be disabled. By default, notify callbacks are
   ...
   code size and improve performance.  */
/* For  NetX in ROM undefining TX_DISABLE_NOTIFY_CALLBACKS  will cause TX_EVENT_FLAGS_GROUP size 
  mismatch in ROM and Wiced, undefining only incase of Netx not in ROM */
