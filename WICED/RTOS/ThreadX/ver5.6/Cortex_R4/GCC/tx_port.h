...
#include "cr4.h"
#define TX_TRACE_TIME_SOURCE                    cr4_get_cycle_counter( )
#endif
...
#if ( defined(ENABLE_NXD_BSD_SOCKET) || defined(ENABLE_NX_BSD_SOCKET) )
...
const CHAR                      _tx_version_id[] = 
                                    "Copyright (c) 1996-2014 Express Logic Inc. * ThreadX Cortex-R4/GNU Version G5.6.5.0 SN: 3510-111-0501 *";
#else
