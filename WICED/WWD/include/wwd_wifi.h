...
/** NAN (Neighbor Awareness Network) APIs */
/**
 * Enables NAN ( neighbor awareness networking)
 * @param[in] none
 * @return @ref wwd_result_t
 */
...
/** get NAN status
 *
 * @param[out]      : wwd_nan_config_status_t
 *                    uint8 enabled
 *                    uint8 inited
 *                    uint8 joined
 *                    uint8 role
 ...
 *                    uint32 cnt_svc_disc_tx       : TX service discovery frame count
 *                    uint32 cnt_svc_disc_rx       : RX service discovery frame count
 ...
 *
 */
extern wwd_result_t wwd_nan_config_get_status ( wwd_nan_config_status_t* nan_cfg_status );
