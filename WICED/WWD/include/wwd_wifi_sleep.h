...
/* Determine if WiFI module needs wake from deep sleep */
extern wiced_bool_t wwd_wifi_ds1_needs_wake( void );

/* Finish process of waking WiFi module */
extern wwd_result_t wwd_wifi_ds1_finish_wake( void );
