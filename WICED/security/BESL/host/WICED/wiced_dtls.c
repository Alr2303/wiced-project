...
{
    return wiced_generic_start_dtls_with_ciphers( socket->dtls_context, socket, ip, type, ( wiced_dtls_certificate_verification_t )verification, my_ciphers, DTLS_UDP_TRANSPORT );
}
...
wiced_result_t dtls_retransmit( wiced_dtls_context_t* dtls_context, dtls_retransmission_node_t* retransmission_node )
{
    ...
    {
        buffer = NULL;
        return ( wiced_result_t )DTLS_ERROR;
    }
