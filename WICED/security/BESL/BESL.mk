...
ifneq ($(wildcard $(CURDIR)BESL.$(HOST_ARCH)$(DOT_TOOLCHAIN_TYPE).release.a),)
ifeq ($(HOST_HARDWARE_CRYPTO),1)
# Micro specific prebuilt library with hardware crypto support
$(NAME)_PREBUILT_LIBRARY := BESL.$(HOST_OPENOCD)$(DOT_TOOLCHAIN_TYPE).release.a
else
# Architecture specific prebuilt library
$(NAME)_PREBUILT_LIBRARY := BESL.$(HOST_ARCH)$(DOT_TOOLCHAIN_TYPE).release.a
