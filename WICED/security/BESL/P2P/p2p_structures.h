...
#define P2P_MAX_OP_CLASSES           (3)
#define P2P_MAX_OP_CLASS_CHANNELS    (15)
#define P2P_MAX_CHANNEL_LIST_ELEMENT (32)
...
{
    uint8_t   country_string[3];
    uint8_t   p2p_chan_list_tlv[P2P_MAX_CHANNEL_LIST_ELEMENT];
} p2p_channel_list_tlv_data_t;

typedef struct
{
    uint8_t   operating_class;
    uint8_t   number_of_channels;
    uint8_t   channel_list[P2P_MAX_OP_CLASS_CHANNELS];
} p2p_channel_list_t;
...
typedef struct
{
    uint8_t   type;   // 11
    uint16_t  length;
    uint8_t   total_classes;
    uint8_t   total_channels;
    p2p_channel_list_tlv_data_t p2p_chan_list;
    // List of channels
...
{
    uint8_t                 country_string[3];
    uint8_t                 p2p_channel_list_table[P2P_MAX_OP_CLASSES][P2P_MAX_OP_CLASS_CHANNELS + 2];
...
typedef struct
{
    ...
    p2p_channel_info_t              operating_channel;
    p2p_channel_list_info_t         channel_list;
    p2p_channel_list_info_t         common_channel_list;
