...
wiced_result_t wiced_wifi_find_best_channel(int32_t band, uint32_t *channel, uint8_t *cca_score)
{
    return ( wiced_result_t )wwd_wifi_get_best_cca(band, channel, cca_score, 75); /* 75 ms dwell time by default */
}
