...
package_bootloader: bootloader display_map_summary package_dct
	$(call ADD_TO_PACKAGE, $(BOOTLOADER_FINAL_TRX_FILE), $(SFLASH_BOOTLOADER_LOC))
...
ifeq (1, $(FAILSAFE_APP_SECURE))
	...
	$(QUIET)$(ECHO) Downloading OOTA2 Failsafe App FAILSAFE_APP_SECURE is $(FAILSAFE_APP_SECURE) ...
...
package_dct: $(DCT_IMAGE_PLATFORM) display_map_summary
	...
	$(call ADD_TO_PACKAGE, $(DCT_IMAGE_PLATFORM), $(SFLASH_DCT_LOC))
ifeq (1, $(DCT_IMAGE_SECURE))
