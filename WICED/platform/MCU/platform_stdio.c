...
#ifndef WICED_DISABLE_STDIO
    if ( stdio_driver != NULL && stdio_block == WICED_FALSE )
    {
...
void platform_stdio_block( int on )
{
#ifndef WICED_DISABLE_STDIO
    stdio_block = on;
#else
...
void platform_stdio_tx_lock( void )
{
#ifndef WICED_DISABLE_STDIO
    host_rtos_get_semaphore( &stdio_tx_mutex, NEVER_TIMEOUT, WICED_FALSE );
#endif
...
void platform_stdio_tx_unlock( void )
{
#ifndef WICED_DISABLE_STDIO
    host_rtos_set_semaphore( &stdio_tx_mutex, WICED_FALSE );
#endif
...
void platform_stdio_rx_lock( void )
{
#ifndef WICED_DISABLE_STDIO
    host_rtos_get_semaphore( &stdio_rx_mutex, NEVER_TIMEOUT, WICED_FALSE );
#endif
...
void platform_stdio_rx_unlock( void )
{
#ifndef WICED_DISABLE_STDIO
    host_rtos_set_semaphore( &stdio_rx_mutex, WICED_FALSE );
#endif
