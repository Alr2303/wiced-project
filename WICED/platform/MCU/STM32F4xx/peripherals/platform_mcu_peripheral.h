...
/* UART powersave wakeup function */
typedef platform_result_t (*platform_uart_wakeup_function_t) ( void );

/* UART powersave sleep function */
typedef platform_result_t ( *platform_uart_sleep_function_t ) (void );
...
typedef struct
{
    ...
    platform_uart_wakeup_function_t wakeup_func;
    platform_uart_sleep_function_t  sleep_func;
} platform_uart_t;
