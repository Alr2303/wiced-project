...
CFLAGS += -nostartfiles
CFLAGS += $(addprefix -Wl$(COMMA)-T ,$(WICED_SDK_DCT_LINK_SCRIPT))
...
$(BUILD_STRING):
	...
	$(QUIET)$(CC) $(CFLAGS) $(OUTPUT_DIR)/factory_reset/factory_reset_dct_$(EXTENSION).c $(WICED_SDK_DEFINES) -I$(OUTPUT_DIR) -I$(SOURCE_ROOT). -I$(SOURCE_ROOT)apps/$(APP_FULL) -o $(OUTPUT_DIR)/factory_reset/factory_reset_dct_$(EXTENSION).elf
