...
void application_start( )
{
    ...
    sd_msglevel = SDH_ERROR_VAL | SDH_TRACE_VAL | SDH_INFO_VAL | SDH_DEBUG_VAL | SDH_DATA_VAL | SDH_CTRL_VAL | SDH_LOG_VAL | SDH_DMA_VAL;
    sd_msglevel = SDH_ERROR_VAL | SDH_TRACE_VAL | SDH_INFO_VAL | SDH_DEBUG_VAL | SDH_DATA_VAL | SDH_LOG_VAL | SDH_DMA_VAL;
    sd_msglevel = SDH_ERROR_VAL | SDH_TRACE_VAL;
...
#if 0
    copy_file( &fs_handle, "/src/mp3/001.MP3", "/tgt/mp3/001.MP3" );
    printf("End\n");
