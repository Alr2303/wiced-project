...
NAME := App_Apple_HomeKit_Tunnel

$(NAME)_SOURCES    := tunnel.c \
                      tunnel_ble.c \
                      tunnel_response.c \
                      wiced_bt_cfg.c \
...
GLOBAL_DEFINES     := WPRINT_ENABLE_APP_DEBUG=TRUE

# Bluetooth trace log to BTSpy.  Uncomment following line and set IP address to the PC
# that runs BTSpy.  Trace will be sent via WiFi.
#GLOBAL_DEFINES    += HCI_LOG_IP=0x0a1d079e
...
VALID_PLATFORMS    := BCM943907WCD1 BCM943909WCD* BCM943438WLPTH_2 BCM943907AEVAL2F_1
