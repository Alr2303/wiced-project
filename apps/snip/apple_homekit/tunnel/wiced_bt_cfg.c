...
{
    .device_name               = (uint8_t*)"WICED Tunnel",    /**< Local device name (NULL terminated) */
    ...
    .ble_scan_cfg =                    /**< BLE scan settings */
    {
        ...
        .high_duty_conn_duration      = 300,                                                 /**< High duty cycle connection duration in seconds (0 for infinite) */
    ...
    .gatt_cfg =                       /**< GATT settings */
    {
         ...
         .client_max_links = 8,   /**< Client config: maximum number of servers that local client can connect to  */
    ...
    .l2cap_application =
     {
         .max_links       = 7, /**< Maximum number of application-managed l2cap links (BR/EDR and LE) */
         ...
         .max_le_channels = 7, /**< Maximum number of application-managed LE channels */
     },
