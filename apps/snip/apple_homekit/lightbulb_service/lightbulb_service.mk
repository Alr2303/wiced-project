...
NAME := App_Apple_HomeKit_Lightbulb_Service

$(NAME)_SOURCES    := lightbulb_service.c\
...
ifeq ($(PLATFORM),$(filter $(PLATFORM),BCM943909WCD1_3 BCM943907WCD1 BCM943907WCD2 BCM943907AEVAL1F BCM943907AEVAL2F CYW943907AEVAL1F))
...
# You can have a higher pool buffer size for 90x platform for better performance
GLOBAL_DEFINES     += TX_PACKET_POOL_SIZE=25
GLOBAL_DEFINES     += RX_PACKET_POOL_SIZE=25
endif
