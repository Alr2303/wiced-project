...
static void ota2_config_command_help( void )
{
    ...
    OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("    ota2_reboot  <0|1|y|n>              : Reboot after successful OTA2 download\r\n"));
    OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("    ota2_uri  <new_URI>                 : Location of OTA2 image file\r\n"));
    OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("    save                                : save changes\r\n"));
}
    ...
    switch( cmd )
    {
        ...
        break;
         case CONFIG_CMD_DOWNLOAD_URI:
         {
             ...
             OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("OTA2 Default Update URI: %s \r\n", player->dct_app->ota2_update_uri));
             break;
         }
         break;
        default:
...
static void ota_test_print_network_info(ota2_data_t* player)
{
    ...
    OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("       Interface: %s\r\n",
           ...
           "Unknown"));
    OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("        Hostname: %s\r\n", player->dct_network->hostname.value));
...
static void ota_test_print_wifi_info(ota2_data_t* player)
{
    ...
    if (player->dct_network->interface == WICED_STA_INTERFACE)
    {
        ...
        OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("          Channel: %d\r\n", (int)channel));
        OTA2_APP_PRINT(OTA2_LOG_NOTIFY, ("             Band: %s\r\n", (band == WICED_802_11_BAND_2_4GHZ) ? "2.4GHz" : "5GHz"));
    }
    else
    {
        /*
