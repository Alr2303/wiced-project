...
#define CLIENT_AP_SSID       "YOUR_AP"
#define CLIENT_AP_PASSPHRASE "YOUR_AP_PASSWORD"
...
/* To use a secondary AP the device will connect to to get the OTA2 update
 * un-comment and set parameters appropriately
 */
//#define CLIENT_AP_2_SSID       "YOUR_AP_2"
//#define CLIENT_AP_2_PASSPHRASE "YOUR_AP_2_PASSWORD"
//#define CLIENT_AP_2_BSS_TYPE   WICED_BSS_TYPE_INFRASTRUCTURE
//#define CLIENT_AP_2_SECURITY   WICED_SECURITY_WPA2_AES_PSK
//#define CLIENT_AP_2_CHANNEL    6
...
/* This is the network interface the device will work with as a default
 *  If you want your default to be WICED_ETHERNET_INTERFACE change it here
 */
