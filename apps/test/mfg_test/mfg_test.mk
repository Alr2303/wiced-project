...
ifneq ($(PLATFORM),$(filter $(PLATFORM), BCM943364WCD1 BCM94343WWCD1 BCM943438WCD1 BCM94343WWCD2 OMNI ))
...
# iperf inclusion
#==============================================================================
ifeq (,$(filter $(PLATFORM),BCM943364WCD1 BCM94343WWCD1 BCM943438WCD1 BCM94343WWCD2 OMNI))
MFG_TEST_ENABLE_IPERF :=1
GLOBAL_DEFINES   += MFG_TEST_ENABLE_IPERF
endif

# Uncomment the below line to Enable Iperf & TCP pool tunables for Low memory platforms: BCM943438WWCD1, BCM43364WCD1, BCM94343WWCD1, BCM94343WWCD2
...
GLOBAL_DEFINES := $(filter-out TX_PACKET_POOL_SIZE=2 RX_PACKET_POOL_SIZE=2 PBUF_POOL_TX_SIZE=2 PBUF_POOL_RX_SIZE=2, $(GLOBAL_DEFINES))
ifeq ($(NETWORK), LwIP)
GLOBAL_DEFINES += TX_PACKET_POOL_SIZE=6 \
                  RX_PACKET_POOL_SIZE=6 \
                  PBUF_POOL_TX_SIZE=4 \
                  PBUF_POOL_RX_SIZE=3
else # For NetX or NetX_Duo stack
GLOBAL_DEFINES += TX_PACKET_POOL_SIZE=4 \
                  RX_PACKET_POOL_SIZE=3 \
                  WICED_TCP_TX_DEPTH_QUEUE=2 \
