...
class CAPI:
    ...
    def __init__(self, conn, addr, uart, outfile):
        ...
        self.command_list = (('sta_get_mac_address', self.sta_get_mac_address),
...
#            time.sleep(1)
    ...
    def sta_get_mac_address(self, args):
        # TODO: The value of the interface(the 1st parameter) is not checked
        self.UCC_Write("status,RUNNING")
        return_value_list = ["mac"]
        self.WicedWrite("getmac\r\n")
        Wiced_reply = self.WicedRead()
