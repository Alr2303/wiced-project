...
ifeq ($(PLATFORM),$(filter $(PLATFORM), BCM943438WCD1 BCM943907WAE2_1 CYW943907WAE3 ))
...
ifeq ($(PLATFORM),$(filter $(PLATFORM), BCM943341WAE BCM943340WCD1 BCM9WCD2REFAD.BCM943012A0FCREF_3 ))
CONSOLE_NO_P2P :=1
endif

BCM94390x_ETHERNET_PLATFORMS := BCM943909* BCM943907* CYW943907AEVAL1F*
...
BCM943907AEVAL1F_PLATFORMS := BCM943907AEVAL1F* CYW943907AEVAL1F*
...
GLOBAL_DEFINES += CONSOLE_THREAD_STACKSIZE=3072
ifeq ($(WICED_DISABLE_COMMON_PKT_POOL),1)
GLOBAL_DEFINES += TX_PACKET_POOL_SIZE=12 \
...
BCM94390x_PLATFORMS := BCM943909* BCM943907* BCM943903* CYW943907*
...
# somp platform need a specific setting for passing tcp and udp testing. and remove some commands to free memory space.
ifeq ($(PLATFORM),$(filter $(PLATFORM),BCM943340WCD1 BCM943362WCD4 ))
CONSOLE_NO_P2P :=1
