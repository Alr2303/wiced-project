...
typedef struct
{
    ...
    powersave_dct_t powersave_params;
    wiced_bool_t mcu_clock_freq_for_mp3;
} headset_upnpavrender_audio_userdata_t;

 typedef struct
 {
    upnpavrender_service_ref              service_handle;
    upnpavrender_service_params_t         service_params;
    headset_upnpavrender_audio_userdata_t audio_userdata;
 } headset_upnpavrender_context_t;
