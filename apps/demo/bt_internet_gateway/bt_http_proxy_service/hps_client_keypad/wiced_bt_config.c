...
{
    .device_name               = (uint8_t*)"WICED HPS Keypad", /**< Local device name (NULL terminated) */
    ...
    .gatt_cfg =                       /**< GATT settings */
    {
         ...
         .max_attr_len     = HPS_CLIENT_MAX_ATTRIBUTE_LENGTH, /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
