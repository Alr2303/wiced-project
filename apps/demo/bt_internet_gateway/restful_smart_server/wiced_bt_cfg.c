...
wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .gatt_cfg =                       /**< GATT settings */
    {
         ...
         .max_attr_len     = MAX_GATT_ATTRIBUTE_LENGTH, /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
...
/*  { buf_size, buf_count } */
    ...
    { MAX_GATT_ATTRIBUTE_LENGTH, 4  }, /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
    { MAX_GATT_ATTRIBUTE_LENGTH, 12 }, /* Large Buffer Pool  (used for HCI ACL messages) */
