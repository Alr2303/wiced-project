...
typedef enum
{
     ...
     */
    /* Play or Pause on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_PAUSE_PLAY,
    /* Sends "Stop" music(a remote control command) command on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_STOP,
    /* Skip Forward the Audio/Music on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_FORWARD,
    /* Stop backwards Audio/Music on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_BACKWARD,
    /* Send Volume UP command on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_VOLUME_UP,
    /* Send Volume DOWN on the remote audio source[With Bluetooth or Airplay]  */
    ACTION_VOLUME_DOWN,
    /* Launch WAC process for Airplay */
...
typedef enum {
    ...
    SERVICE_BT_A2DP     =   (2),         //!< SERVICE_BT_A2DP
    SERVICE_BT_HFP      =   (3),         //!< SERVICE_BT_HFP
} service_type_t;
