...
static wiced_result_t app_wac_launch(void);
...
static const wiced_button_manager_configuration_t button_manager_configuration =
{
    ...
    .long_hold_duration      = 3000  * MILLISECONDS,
...
static const button_action_function_table_t action_table[] =
{
    ...
    { ACTION_AIRPLAY_WAC_LAUNCH,                app_wac_launch,                          NULL },
...
static wiced_result_t app_wac_launch(void)
{
    ...
    WPRINT_APP_INFO(("[App] Set-up for WAC and reboot\n"));
    wiced_app_reset_for_wac();
...
static void app_button_event_handler( const button_manager_button_t* button, button_manager_event_t event, button_manager_button_state_t state )
{
    ...
    switch ( button_event_id )
    {
        ...
        case BUTTON_EVENT_ID( BACK_BUTTON,           BUTTON_LONG_DURATION_EVENT,  BUTTON_STATE_RELEASED ): new_action = ACTION_AIRPLAY_WAC_LAUNCH; break;
        ...
        default: WPRINT_LIB_INFO(("[App] Button unhandled button_event_id: %x\n", (unsigned int)button_event_id)); return;
    }
