...
/*
 * @file:   airplay_audio.h
 *
 * This file Contains airplay-related info and definitions.
 *
 */
 ...
 *                    Constants
 ******************************************************/
#define AIRPLAY_SPEAKER_NAME_STRING_LENGTH  (35)
#define AIRPLAY_PLAY_PASSWORD_STRING_LENGTH (51)
...
typedef struct
{
    ...
    wiced_bool_t                is_airplay_server_up;
    char                        ssid_str[SSID_NAME_SIZE+1];
} airplay_audio_context_t;

typedef struct
{
    char speaker_name[AIRPLAY_SPEAKER_NAME_STRING_LENGTH + 1];
    char play_password[AIRPLAY_PLAY_PASSWORD_STRING_LENGTH + 1];
} airplay_dct_t;
