 ...
 *  -- Follow below links helps in understanding how to use azure iot hub
 *   * Https://github.com/azure/azure-iot-sdk-c
 *   * Https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-security#security-tokens
 *   * Https://github.com/Microsoft/azure-docs/blob/master/includes/iot-secure-your-deployment.md
 *
 */
/******************************************************
 *                      Macros
...
void application_start( void )
{
    ...
    if ( connection_instance.conn != NULL )
    {
        ...
        ret = wiced_amqp_deinit( &connection );
