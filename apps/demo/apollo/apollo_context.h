...
typedef enum
{
    ...
    APOLLO_EVENT_OTA2_UPDATE_PERCENT  = (1 << 24),
...
typedef struct
{
    ...
    wiced_bool_t                ota2_stop_bg_service;                   /* if WICED_TRUE, stop the OTA2 Background (timed) update
                                                                         * after download is complete. Set to WICED_TRUE
                                                                         * if no timed update was running and the "get_update"
                                                                         * console command was used to start an update.
                                                                         * For timed updates, set to WICED_FALSE;
                                                                         */
