...
/* amount of hold time on button (at startup only) to get an OTA2 update */
#define OTA2_HOLD_TIME_FOR_ONE_BUTTON_UPDATE    ( 5000 )
...
typedef struct
{
    ...
    ota2_service_callback                   cb_func;            /* OTA2 callback function                   */
