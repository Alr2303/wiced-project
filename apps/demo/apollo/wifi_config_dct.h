...
/* CLIENT_AP_SSID specifies the SSID the device will attempt connect to (as a STA/client).
 * When using RMC + Infrastructure:
 *     - CLIENT_AP_SSID specifies the upstream AP.
 *     - If CLIENT_AP_SSID is empty ("") then no STA interface is created.
 *     - CLIENT_AP_CHANNEL and CLIENT_AP_BAND are unused.
 */
