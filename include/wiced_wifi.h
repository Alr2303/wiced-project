...
/** Initializes the WLAN parts of WICED
 *
...
/*****************************************************************************/
/** @addtogroup wifiultilities   WiFi Utility Functions
 *  @ingroup wifi
 *
 *  WICED functions to
 *    - find AP
 ...
 *  @ingroup wifi
 *  WICED Wi-Fi functions for DS1 Entry/Exit and Debug.
 *
 *  @{
 */
/****************************************************************************/
...
/**
 * Gets information about the AP the client RSSI
 *
 * @note Only applicable if STA (client) interface is associated to an AP
 *
...
/*****************************************************************************/
/** @addtogroup wifinan       WiFi Neighbor Awareness Networking
 *  @ingroup wifi
 *    WLAN NAN (neighbor awareness networking)
