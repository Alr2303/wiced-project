...
#define PLATFORM_COMMANDS \
    ...
    { "loglevel_set",       wiced_log_set_level_console_command,  1, NULL, NULL, "<loglevel>", "set new wiced logging level"}, \
    { "loglevel_get",       wiced_log_get_level_console_command,  0, NULL, NULL, NULL, "get current wiced logging level"}, \
