                ...
                if ((logical_channel >= 0) && (logical_channel <= 1))
                {
                     ...
                     if ((bb_packet_type >= 3) && (bb_packet_type <= 15))
                     {
                         ...
                         if ((packet_length >= 0) && (packet_length <= 0xffff))
                         {
                             ...
                             {
                                 return execute_radio_tx_test(argv[1], frequency, modulation_type, logical_channel, bb_packet_type, packet_length, tx_power);
                             }
                         }
                     }
                }
                ...
                if ((logical_channel >= 0) && (logical_channel <= 1))
                {
                    ...
                    if ((bb_packet_type >= 3) && (bb_packet_type <= 15))
                    {
                        ...
                        if ((packet_length >= 0) && (packet_length <= 0xffff))
                        {
                            ...
                            {
                                return execute_radio_rx_test(argv[1], frequency, modulation_type, logical_channel, bb_packet_type, packet_length, test_period);
                            }
                        }
                    }
                }
