...
#define WIFI_COMMANDS \
    ...
    { (char*) "get_btc_params",                     get_btc_params,                     1, NULL, NULL, (char*) " <address in hex> [interface]",                     (char*) "Read BTC Params"}, \
