...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@group		kAudioDevicePropertyStarkStreamAudioDSPType
	@abstract	Gets or sets the type of signal processing to apply to the Stark stream(s) associated with the device.
*/

#define kAudioDevicePropertyStarkStreamAudioDSPType		0x73746164 // 'stad'
	// Scope:		kAudioObjectPropertyScopeInput or kAudioObjectPropertyScopeOutput or kAudioObjectPropertyScopeGlobal.
	// Element:		kAudioObjectPropertyElementMaster
	// Qualifier:	none.
	// Data Type:	uint32_t

#define kAudioDevicePropertyStarkStreamAudioDSPType_Default					0x64736466 // 'dsdf'
#define kAudioDevicePropertyStarkStreamAudioDSPType_SpeechRecognition		0x64737372 // 'dssr'
#define kAudioDevicePropertyStarkStreamAudioDSPType_Telephony				0x64737465 // 'dste'
