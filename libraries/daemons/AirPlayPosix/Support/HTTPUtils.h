...
typedef enum
{
	...
	kHTTPStatus_ResumeIncomplete					= 308, // "Resume Incomplete"
	...
	kHTTPStatus_BlockedByParentalControls			= 450, // "Blocked by Parental Controls"
	...
	kHTTPStatus_ClientClosedRequest					= 499, // "Client Closed Request"
	...
	kHTTPStatus_NetworkReadTimeout					= 598, // "(Informal convention) network read timeout error"
	kHTTPStatus_NetworkConnectTimeout				= 599, // "(Informal convention) network connect timeout error"
...
#define IsHTTPSuccessStatusCode( X )			IsHTTPStatusCode_Success( X )
