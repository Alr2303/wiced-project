...
// CF_ZLIB: 1=Allow ZLib to be used, 0=Don't use ZLib.
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFZLibCompress
	
	@abstract	Compresses the input buffer with ZLib and returns a malloc'd buffer containing the compressed data.
*/
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFZLibExpand
	
	@abstract	Expands the input buffer with ZLib and returns a malloc'd buffer containing the uncompressed data.
*/
