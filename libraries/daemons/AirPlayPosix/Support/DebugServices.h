...
// Deprecated DebugLevel defines. Use the kLogLevel* defines instead.

#define kDebugLevelMask					kLogLevelMask
#define kDebugLevelChatty				kLogLevelChatty
#define kDebugLevelVerbose				kLogLevelVerbose
#define kDebugLevelTrace 				kLogLevelTrace
#define kDebugLevelInfo 				kLogLevelInfo
#define kDebugLevelNotice				kLogLevelNotice
#define kDebugLevelWarning				kLogLevelWarning
#define kDebugLevelAssert 				kLogLevelAssert
#define kDebugLevelRequire				kLogLevelRequire
#define kDebugLevelError				kLogLevelError
#define kDebugLevelCritical				kLogLevelCritical
#define kDebugLevelAlert				kLogLevelAlert
#define kDebugLevelEmergency			kLogLevelEmergency
#define kDebugLevelTragic				kLogLevelTragic
#define kDebugLevelMax					kLogLevelMax

#define kDebugLevelFlagMask				kLogLevelFlagMask
#define kDebugLevelFlagStackTrace		kLogLevelFlagStackTrace
#define kDebugLevelFlagDebugBreak		kLogLevelFlagDebugBreak
#define kDebugLevelFlagForceConsole		kLogLevelFlagForceConsole
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	map_errno
	@abstract	Returns 0 if TEST is true. Returns an error code if TEST is false.
*/

	#define map_errno( TEST )		( (TEST) ? 0 : errno_compat() ? errno_compat() : kUnknownErr )
...
// dlog
	...
	int	DebugLog_C89( const char *inFunction, LogLevel inLevel, const char *inFormat, ... );
		...
		#define	dlog( ... )			ulog( &log_category_from_name( DebugServicesLogging ), __VA_ARGS__ )
...
//			  Note: MDNS_DEBUGMSGS must be defined (even if just defined to 0) for this feature to be enabled.
