		...
		CFErrorRef *			outError )
{
	...
	CFBinaryPlistCreateFromData( inAllocator, ptr, len, &plist );
	if( plist )
	{
...
void	CFDateGetComponents( CFDateRef inDate, int *outYear, int *outMonth, int *outDay, int *outHour, int *outMinute, int *outSecond )
{
