...
*/
/*!
	@header Preferences Interface
	@discussion Provides APIs for Preferences information.
*/
...
// CFL_SORT_DICTIONARY_XML: 1=Sort Dictionaries by key when outputing XML. 0=Don't sort.
...
// CFCOMPAT_HAS_UNICODE_SUPPORT: 1=Use utfconv for Unicode conversions. 0=No Unicode support (everything nust be UTF-8).
...
#define kCFPropertyListBinaryFormat_CFLite		1000
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFPreferencesCopyAppValue_compat
	@abstract	Copies/gets a platform-specific property 

	@param	inKey	Property to be retrieved
	@param	inAppID Reserved

	@result	CFPropertyList containing the value of the property specified. 
	...
	@textblock
              ...
              inKey                                type
              -----                                ------
        - kAirPlayTXTKey_Seed                      CFSTR   
             Return the value of the seed count. It will be updated by AirPlay.
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFPreferencesSetAppValue_compat
	@abstract	Sets a platform-specific property 

	@param	inKey	Property to be set
	...
	@textblock
              ...
              -----                                ------
        - kAirPlayTXTKey_Seed                      CFSTR   
             Set the value of the seed count. 
...
extern CFRunLoopRef	CFRunLoopGetMain( void ); // Available, but not declared until Leopard.
