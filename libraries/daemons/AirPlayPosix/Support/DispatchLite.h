...
#ifndef	__DispatchLiteDotH__
#define	__DispatchLiteDotH__
...
// DISPATCH_LITE_ENABLED -- Controls whether to emulate libdispatch or not.
	...
	#if( ( ( TARGET_OS_IPHONE || TARGET_OS_EMBEDDED ) && ( __IPHONE_OS_VERSION_MAX_ALLOWED > 30200 ) ) ||	\
		 ( !TARGET_OS_IPHONE && ( MAC_OS_X_VERSION_MAX_ALLOWED >= 1060 ) ) )
