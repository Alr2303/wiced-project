...
#ifndef	__UUIDUtilsDotH__
#define	__UUIDUtilsDotH__

#include "CommonServices.h"

// UUID_NO_LIB_SUPPORT -- 1=No library support for UUID's so make them manually.

#if( !defined( UUID_NO_LIB_SUPPORT ) )
		#define UUID_NO_LIB_SUPPORT		0
#endif
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	UUIDGetHost
	@abstract	Gets the globally unique and persistent UUID for this host (i.e. the computer's UUID).
*/
