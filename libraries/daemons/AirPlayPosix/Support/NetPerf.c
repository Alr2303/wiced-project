...
static OSStatus	_NetPerfServerSessionSetUp( NetPerfRef me, CFDictionaryRef inParams, CFDictionaryRef *outResponse )
{
	...
	if( IsValidSocket( me->serverDataSockV4 ) ) SocketSetPacketTimestamps( me->serverDataSockV4, true );
	if( IsValidSocket( me->serverDataSockV6 ) ) SocketSetPacketTimestamps( me->serverDataSockV6, true );
