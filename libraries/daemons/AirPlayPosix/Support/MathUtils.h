...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	ifloor2
	@abstract	Rounds down to an integral power of 2 >= x. 0 and 1 are considered powers of 2. Valid for 0 >= x <= 2^32-1.
*/
...
#if  ( TARGET_HAS_BUILTIN_CLZ )

	STATIC_INLINE uint32_t	ilog2( uint32_t x )
	{
...
/*!	@function	StandardDeviation
	@abstract	Calculates the standard deviation of an array of values.
