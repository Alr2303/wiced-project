...
/*!	@typedef	CFLAllocatorRef
	...
	@constant	kCFLAllocatorDefault	(0) Default allocator.
*/

typedef struct CFLAllocator *		CFLAllocatorRef;

#define	kCFLAllocatorDefault		0
...
extern const CFLArrayCallBacks		kCFLArrayCallBacksCFLTypes;
...
extern const CFLArrayCallBacks		kCFLArrayCallBacksNull;
...
extern CFLBooleanRef			kCFLBooleanTrue;
extern CFLBooleanRef			kCFLBooleanFalse;
...
/*!	@function	CFLDataCreate
	@abstract	Creates a CFLData object from a program-supplied data.
	@result		An error code indicating failure reason or kNoErr (0) if successful.
	@discussion
...
extern const CFLDictionaryKeyCallBacks			kCFLDictionaryKeyCallBacksCFLTypes;
...
extern const CFLDictionaryKeyCallBacks			kCFLDictionaryKeyCallBacksNull;
...
extern const CFLDictionaryValueCallBacks		kCFLDictionaryValueCallBacksCFLTypes;
...
extern const CFLDictionaryValueCallBacks		kCFLDictionaryValueCallBacksNull;
