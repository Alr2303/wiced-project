...
typedef enum
{
    APOLLO_STREAMER_COMMAND_PUSH_BUFFER,            /*!< argument must be of type @ref apollo_streamer_buf_t */
    APOLLO_STREAMER_COMMAND_SET_AUDIO_CONFIG,       /*!< argument must be of type @ref wiced_audio_config_t  */
    APOLLO_STREAMER_COMMAND_START,                  /*!< no argument                                         */
    APOLLO_STREAMER_COMMAND_STOP,                   /*!< no argument                                         */
    APOLLO_STREAMER_COMMAND_SET_VOLUME_ATTENUATION, /*!< argument must of type @ref uint8_t from 0 to 100    */
    APOLLO_STREAMER_COMMAND_SEND_EOS                /*!< no argument                                         */
