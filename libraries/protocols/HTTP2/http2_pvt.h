 ...
 *                      Macros
 ******************************************************/
#define HTTP_DEBUG( X )     //printf("  ======= HTTP/2 CLIENT - DBG : "); printf X
...
#define HTTP2_FRAME_HEADER_FRAME_FLAG_PADDED      (0x8)
#define HTTP2_FRAME_HEADER_FRAME_FLAG_PRIORITY    (0x20)

#define HTTP2_FRAME_FLAGS_SETTINGS_ACK            (0x01)
#define HTTP2_FRAME_FLAGS_PING_ACK                (0x01)
#define HTTP2_FRAME_FLAGS_DATA_END_STREAM         (0x01)
#define HTTP2_FRAME_FLAGS_DATA_END_HEADERS        (0x04)
#define HTTP2_FRAME_FLAGS_DATA_PADDED             (0x08)
#define HTTP2_FRAME_FLAGS_DATA_PRIORITY           (0x20)
#define HTTP2_FRAME_FLAGS_PUSH_PROMISE_END_HEADERS (0x04)
#define HTTP2_FRAME_FLAGS_PUSH_PROMISE_PADDED     (0x08)
...
wiced_result_t http_frame_put_ping      ( http2_frame_t* frame, uint8_t data[HTTP2_PING_DATA_LENGTH], uint8_t flags );
