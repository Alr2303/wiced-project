...
#define DEFAULT_INCOMING_WINDOW  1024
#define DEFAULT_OUTGOING_WINDOW  1024
/******************************************************
 *                    Constants
 ******************************************************/
...
wiced_result_t amqp_frame_get_begin_performative( wiced_amqp_frame_t *frame, void *args );
wiced_result_t amqp_frame_put_begin( wiced_amqp_frame_t *frame,  void* args );
