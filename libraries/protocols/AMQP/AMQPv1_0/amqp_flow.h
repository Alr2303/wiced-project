...
wiced_result_t amqp_frame_get_flow_performative( wiced_amqp_frame_t *frame, void *args );
wiced_result_t amqp_frame_put_flow( wiced_amqp_frame_t *frame,  void* args );
