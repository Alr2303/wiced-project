 ...
 */
wiced_result_t amqp_connection_backend_put_protocol_header( const wiced_amqp_protocol_header_arg_t *args, wiced_amqp_connection_instance *conn );
wiced_result_t amqp_connection_backend_get_protocol_header( wiced_amqp_protocol_header_arg_t *args, wiced_amqp_connection_instance *conn );
