 ...
 *   Note           The remote device shall be disconnected if already connected
 ...
 * @param[in]       power    : input power to be set , range should be between -12 to 16 dbm  Min Val is 16dbm and Max val is -12
 *  Note : The range varies for different platforms , refer data sheet for the range
 * @return          WICED_BT_SUCCESS if successful
 *                      WICED_BT_NO_RESOURCES if could not allocate resources to start the command
