...
#define UX_HOST_CLASS_CDC_ACM_CLASS_TRANSFER_TIMEOUT_DEFAULT    300000
#define UX_HOST_CLASS_CDC_ACM_CLASS_TRANSFER_TIMEOUT            ( cdc_acm -> ux_host_class_cdc_acm_transfer_timeout )
...
/* Define CDC ACM private IOCTL for user configuration */
...
typedef struct UX_HOST_CLASS_CDC_ACM_STRUCT
{
    ...
    ULONG          ux_host_class_cdc_acm_transfer_timeout;
