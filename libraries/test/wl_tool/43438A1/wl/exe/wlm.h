 ...
 *
 * $Id: wlm.h 445566 2013-12-27 09:20:37Z jwang $
 */
...
#define WLM_VERSION_STR "wlm version: 7.10.0.13 (support 4335, 4345, 4350 and more )"
 ...
 */
WLM_FUNCTION
int wlmPhyRPCalValsSet(int rpcal2g, int rpcal5gb0, int rpcal5gb1, int rpcal5gb2, int rccal5gb3);
 ...
 */
WLM_FUNCTION
int wlmPhyRPCalValsGet(int *rpcal2g, int *rpcal5gb0, int *rpcal5gb1,
	int *rpcal5gb2, int *rccal5gb3);
