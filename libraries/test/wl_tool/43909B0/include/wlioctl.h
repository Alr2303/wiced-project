 ...
 *
 * $Id: wlioctl.h 511535 2014-10-30 03:16:16Z dweng $
 */
...
typedef BWL_PRE_PACKED_STRUCT struct {
	...
	uint8		ofdm;		/* OFDM */
} BWL_POST_PACKED_STRUCT assoc_info_t;
...
#if defined(BCMCCX) || defined(BCMSUP_PSK) || defined(BCMDONGLEHOST)
...
#endif /* defined(BCMCCX) || defined(BCMSUP_PSK) || defined(BCMDONGLEHOST) */
#endif /* LINUX_POSTMOGRIFY_REMOVAL */
...
#ifdef SROM12
#define WL_PHY_PAVARS_LEN	48	/* Phytype, Bandrange, chain, a[0], b[0], c[0], d[0] .. */
#else
...
typedef BWL_PRE_PACKED_STRUCT struct wl_p2po_find_config {
	uint16 version;			/* Version of this struct: 1 */
...
typedef BWL_PRE_PACKED_STRUCT struct awdl_scan_event_data {
	...
	uint8	pad;
	uint8	chan_list[1];		/* List of cahced channels followed by
...
#define MIN_AWDL_PSCAN_DWELL_TIME	5  /* in msec, minimum dwell time */
...
typedef BWL_PRE_PACKED_STRUCT struct wl_rssi_event {
	...
	int8 rssi_levels[MAX_RSSI_LEVELS];	/* Variable number of RSSI levels. An event
						 ...
						 */
}  BWL_POST_PACKED_STRUCT wl_rssi_event_t;
...
/* XXX This value is hardcoded to be 16 and MUST match PKTQ_MAX_PREC value defined elsewhere */
...
#define TXPWRCAPSTATE_RESERVED 0
#define TXPWRCAPSTATE_LOW_CAP  1
#define TXPWRCAPSTATE_HIGH_CAP 2

/* IOVAR txcapconfig and txcapstate structure is shared: SET and GET */
#define TXPWRCAPCTL_VERSION 1
