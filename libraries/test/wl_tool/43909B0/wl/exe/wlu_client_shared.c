 ...
 *
 * $Id: wlu_client_shared.c 430136 2013-10-17 10:58:53Z blitvin $
 */
#ifdef WIN32
...
/*Set the server ip from command line parameteres*/
void setServerDetails(char *server_address , int server_port)
{
    g_rwl_servIP  = server_address;
    g_rwl_servport = server_port;
}
