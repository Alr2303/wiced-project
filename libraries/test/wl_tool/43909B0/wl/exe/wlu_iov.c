 ...
 *
 * $Id: wlu_iov.c 444047 2013-12-18 10:57:45Z maheshd $
 *
...
wlu_iov_info_t wlu_iov_info[] = {
    ...
    {
        "avb_timestamp_addr", CMD_UNCAT,
        WLU_IOVI_READ_ONLY, 0,
        "Returns the memory address of the avb timestamp."
    },
	{
	   "avb_timestamp", CMD_UNCAT,
	    WLU_IOVI_READ_ONLY, 0,
	   "Returns the avb timestamp."
	},
    {
       "avb_dump", CMD_UNCAT,
        WLU_IOVI_READ_ONLY, 0,
       "Dumps the avb structure."
    },
    {
       "dot1as_11v_tmp", CMD_UNCAT,
       0, 0,
       "Perform Time-of-Flight Measurement Procedure"
    },
};
