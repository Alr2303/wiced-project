 ...
 *
 * $Id: wlu_iov.c,v 1.17.70.1 2010-07-16 23:07:28 peyush Exp $
 *
...
wlu_iov_info_t wlu_iov_info[] = {
	...
	},
	{
		...
		WLU_IOVI_DEFAULT_VALID, 36,
		"Afterburner min tx threshold rate"
	},
	{
	...
	{
		"afterburner", CMD_UNCAT,
		WLU_IOVI_READ_ONLY, 0,
		"Current dynamic value of the local afterburner mode"
	},
	{
		"afterburner_override", CMD_UNCAT,
		0, 0,
		"off/on/auto: AfterBurner policy value; ON is for testing only."
	},
	{
		"ampdu", CMD_UNCAT,
		0, 0,
	...
	{
		"nphy_antsel", CMD_UNCAT,
		0, 0,
		"no desc"
	},
	{
		"nphy_antsel_override", CMD_UNCAT,
		0, 0,
		"no desc"
	},
	{
